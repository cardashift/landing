...
function RoadMapCard({
  ...
  return (
    <div className="w-full mb-6 sm:mb-0 relative px-6 pb-6 pt-2 sm:w-1/3 rounded-lg border-white border-opacity-40 border-2 shadow-sm bg-button-orange-gradien bg-grayLight bg-blend-soft-light">
      <div
