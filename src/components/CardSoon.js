...
function CardSoon({
  ...
  return (
    <div
      ...
      onClick={onclick}
      className={`${classname} flex justify-between items-center rounded-lg border-2 border-white  px-4 py-6 h-16 border-opacity-40 md:bg-button-orange-gradien bg-grayLight blend`}
    >
