...
function CardSoon({
  ...
  return (
    <div
      ...
      onClick={onclick}
      className={`${classname}  flex cursor-pointer justify-between items-center rounded-lg border-2 border-white  px-4 py-6 h-16 border-opacity-40 bg-button-orange-gradien bg-grayLight blend`}
    >
