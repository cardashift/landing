...
function FundingCap({ topTitle, pricing }) {
  return (
    <div className="w-160 sm:w-52 sm:ml-6 flex flex-col border-2 rounded-lg border-white shadow-sm bg-button-orange-gradien bg-grayLight bg-blend-soft-light py-4 px-6 border-opacity-40 ">
