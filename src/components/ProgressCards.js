...
function ProgressCards({ title, paragraphe, srcImg, btnDisplay }) {
  return (
    <div className="flex flex-col md:flex-row justify-around items-center md:mx-24 py-5 mb-8 border-2 border-white border-opacity-40 md:p-6 rounded-md  bg-button-orange-gradien bg-blend-soft-light bg-grayLight ">
