...
function Profile({ urlPicture, fullName, fonction }) {
  return (
    <div className="rounded-40 border-2 border-white border-opacity-20 bg-button-orange-gradien bg-blend-soft-light bg-grayLight shadow-sm p-4 ">
      <div
        className="flex flex-col justify-end  profile"
        style={{
